...
const BookingCard: React.FC<BookingCardProps> = ({
  ...
  const isBookAgainVisible =
    booking.status_reservation === 'canceled' ||
    booking.status_reservation === 'checked-out';
        ...
        <div className="w-full b flex justify-between">
          <div className="flex-1 p-2 md:pt-2 md:p-0">
            <div className="flex flex-col items-start mb-2 md:flex-row md:items-center">
              <h3 className="text-[18px] md:text-[16px] lg:text-xl font-bold text-gray-800">
                {booking.rooms.room_name}
              </h3>
              <div
                className={`px-2 py-1 rounded-full text-[12px] md:text-[10px] lg:text-[16px] mt-1 md:mt-0 md:ml-4 text-center font-semibold ${getStatusColor(
          ...
          <div className="flex flex-col items-end justify-between mt-2 md:mt-0 md:ml-4 md:min-w-[120px]">
            <div className="text-end">
              ...
              <div className="text-[14px] mb-4">Amount paid</div>
            </div>
            <div className="flex flex-col md:flex-row gap-2">
              ...
              {booking.status_reservation === 'confirmed' ||
              booking.status_reservation === 'pending' ? (
                <button
                  onClick={() =>
                    setAlert({
                      open: true,
